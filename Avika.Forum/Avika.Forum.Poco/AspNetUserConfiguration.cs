...
namespace Avika.Forum.Model
{
    ...
    public class AspNetUserConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<AspNetUser>
    {
        ...
        public AspNetUserConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasOptional(a => a.AspNetRole).WithMany(b => b.AspNetUsers_RoleId).HasForeignKey(c => c.RoleId).WillCascadeOnDelete(false); // FK_dbo.AspNetUsers_dbo.AspNetRoles_RoleId
        }
    }
